 ...
 */
public class ClipboardBranchFileAnnotationAction extends AnnotationAction {

    public ClipboardBranchFileAnnotationAction(@NotNull final FileAnnotation annotation) {
        super(annotation);
    }
    ...
    protected void perform(
        ...
        GitLink.getInstance(project).copyFile(file, commit, lineSelection, true);
    }
}
